// Configuración para la base de datos de estado (prueba2)
export const firebaseConfigEstado = {
  ...
  // Configuración para la base de datos de historial (prueba)
  export const firebaseConfigHistorial = {
